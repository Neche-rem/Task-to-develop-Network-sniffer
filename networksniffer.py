...
def packet_sniffer(filter="", count=0, save=False, filename="captured_packets.pcap"):
    ...
    sniff(filter=filter, prn=callback, count=count, store=0)
...
if __name__ == "__main__":
    ...
    packet_filter = "tcp port 80"  # Example for HTTP
    ...
    packet_sniffer(filter=packet_filter, count=packet_count, save=save_to_file, filename=filename)
